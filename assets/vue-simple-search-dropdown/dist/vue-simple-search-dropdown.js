(function t(e, r) {
    ...
    else if (typeof define === "function" && define.amd) define("vue-simple-search-dropdown", [], r);
    else if (typeof exports === "object") exports["vue-simple-search-dropdown"] = r();
    else e["vue-simple-search-dropdown"] = r()
})(window, function() {
    return function(t) {
        var e = {};
...
//                    this.$emit("selected", this.selected);
        ...
        t.exports = function(t, e, r, m, g, x, b) {
            s(r, e, m);
            var w = function(t) {
            ...
            var C = j[l] || j[d] || g && j[g];
            var M = C || w(g);
            var T = g ? !S ? M : w("entries") : undefined;
            var L = e == "Array" ? j.entries || C : C;
            var k, P, E;
            if (L) {
                E = c(L.call(new t));
        ...
        var f = function(t, e, r) {
            ...
            for (x in r) {
                ...
                if (b && u(y, x)) continue;
                w = b ? g[x] : r[x];
                y[x] = l && typeof g[x] != "function" ? r[x] : p && b ? i(w, n) : h && g[x] == w ? function(t) {
                    ...
                    e[s] = t[s];
                    return e
                }(w) : d && typeof w == "function" ? i(Function.call, w) : w;
                if (d) {
                    (y.virtual || (y.virtual = {}))[x] = w;
                    if (t & f.R && m && !m[x]) a(m, x, w)
                }
            }
        };
        f.F = 1;
